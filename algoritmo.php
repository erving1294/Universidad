...
<?php
	...
	/*
		...
		D1 = d1 - y1
		y1 = f(u)	donde u = X1 * W11+ X2 * W21 - teta(O)
		Xn = variables de entrada
	...
	*/
	...
	/* VARIABLES DECLARADAS*/
		$arrayVariableEntradaValido=array();	//X1 	valido
		$arrayVariableEntradaInvalido=array();	//X1	invalido

		$arrayPesoValido = array();				//w1
		$arrayPesoInvalido = array();			//w1

		$arrayNuevoPesoValido = array();		//nuevo w1
		$arrayNuevoPesoInvalido = array();		//nuevo w1

		$arrayD1Valido = array();
		$arrayD1Invalido = array();

		$dv = 1; //Deseado Valido
		$di = 0; //Deseado Invalido
		$n = 0.1;

		$y1_valido =  0;	// y valido;
		$y1_invalido =  0;	// y invalido;
	/* FIN DE VARIABLES DECLARADAS*/


	/* VARIABLE DE ENTRADA DE VALIDO */
	...
	/*	echo number_format($resultado_patronV,4);*/
/*		echo "||";*/
		/*echo number_format($resultado_patronI,4);*/
		/*exit();*/
	...
	function CrearCuadro_3($arrayVariableEntradaValido, $arrayVariableEntradaInvalido, $arrayPesoValido, $arrayNuevoPesoValido, $arrayPesoInvalido, $dv, $y1_valido, $di, $y1_invalido, $n){
		...
		<?php
			...
			/*ReemplazarPesos($arrayNuevoPesoValido);*/
